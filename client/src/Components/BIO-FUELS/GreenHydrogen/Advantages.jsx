...
import { Leaf, Battery, Factory, Droplets, ArrowUpRight } from "lucide-react";
...
export default function Advantages() {
  const advantages = [
    {
      num: "01",
      title: "True Zero Emissions",
      desc: "When utilized in fuel cells or turbines, green hydrogen produces exactly zero carbon emissions—yielding only pure water and heat as byproducts.",
      icon: Leaf,
    },
    {
      num: "02",
      title: "Long-Duration Storage",
      desc: "Acts as a chemical battery, allowing massive amounts of excess solar and wind energy to be stored indefinitely for seasonal grid balancing.",
      icon: Battery,
    },
    {
      num: "03",
      title: "Heavy Industry Decarbonization",
      desc: "The only viable pathway to replace fossil fuels in hard-to-abate sectors like steelmaking, chemical synthesis, and heavy-duty aviation.",
      icon: Factory,
    },
    {
      num: "04",
      title: "Infinite Resource Loop",
      desc: "Produced purely from water and renewable electricity, creating a truly sustainable, closed-loop energy ecosystem independent of fossil reserves.",
      icon: Droplets,
    },
  ];
        ...
        <div className="w-full lg:w-1/3 lg:sticky lg:top-32 h-fit z-20">
          ...
          >
            ...
            <p className="text-[var(--color-text-muted)] text-lg leading-relaxed mb-10 font-light">
              The cornerstone of a zero-carbon future. Green hydrogen unlocks deep decarbonization for industries and grids by turning abundant renewable power into a versatile, high-density fuel.
            </p>
