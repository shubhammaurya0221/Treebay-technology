...
import { ArrowRight, Activity, Beaker, Recycle, Droplets, Layers, Truck } from 'lucide-react';
import { motion } from 'framer-motion';

export default function Process() {
  // 5-Step Detailed Bio-Diesel Process Data
  const steps = [
    {
      num: "01",
      title: "Feedstock Preparation",
      desc: "Used cooking oils, animal fats, or plant oils are collected, filtered to remove solid impurities, and heated to remove excess moisture.",
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1ta6IfdWVIkY-NeZlsAdHMKRwHw1gAk9Cgw&s",
      icon: Recycle
    },
    {
      num: "02",
      title: "Transesterification",
      desc: "The purified oil is mixed with an alcohol (methanol) and a catalyst (like lye) to chemically break down the complex fat molecules.",
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQWQXHOw7bQmfMgBsAgbDk6PjKRDGuGcSUbw&s",
      icon: Activity
    },
    {
      num: "03",
      title: "Phase Separation",
      desc: "The mixture settles into two distinct liquid phases: the lighter bio-diesel (methyl esters) rises to the top, while heavy glycerin sinks.",
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIeNpaVM0zVH4jw9tfsVV-xYNiYh7Jqw3ky4NUMHWWFg&s",
      icon: Layers
    },
    {
      num: "04",
      title: "Washing & Purification",
      desc: "The bio-diesel is washed with warm water to remove residual catalyst, alcohol, and soaps, then dried to ensure maximum purity.",
      img: "https://www.shutterstock.com/image-photo/traditional-purification-ritual-washing-hands-600w-2642230133.jpg",
      icon: Droplets
    },
    {
      num: "05",
      title: "Testing & Distribution",
      desc: "The final B100 fuel undergoes strict quality control to meet global standards before being blended or distributed for transportation.",
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmcTlShH5pB_fZLKA5ZHhDrAUHfWL3G7IDDw&s",
      icon: Truck
    }
  ];
    ...
    <section id="process" className="py-32 px-4 md:px-8 max-w-[100rem] mx-auto w-full border-y border-[var(--color-border)] bg-[var(--color-bg)] overflow-hidden relative">
      ...
      >
        ...
        <h3 className="font-serif text-4xl md:text-5xl lg:text-[3.5rem] font-normal tracking-tight text-[var(--color-text)] leading-[1.1] mb-6 drop-shadow-sm">
          ...
          <span className="italic text-[var(--color-secondary)]">Bio-Diesel Production</span>
        </h3>

        <p className="text-[var(--color-text-muted)] text-sm md:text-base font-light leading-relaxed">
          A fully integrated chemical process designed to convert organic waste oils and fats into clean, high-performance, drop-in renewable liquid fuels.
        </p>
      </motion.div>

      {/* Grid: 1 col for mobile, 5 cols for desktop single line */}
      <motion.div 
