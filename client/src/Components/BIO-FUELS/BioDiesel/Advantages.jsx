...
import { Leaf, Fuel, ShieldCheck, Sprout, ArrowUpRight } from "lucide-react";
  ...
  const advantages = [
    {
      ...
      desc: "Bio-diesel dramatically lowers particulate matter, carbon monoxide, and lifecycle greenhouse gas emissions compared to standard petroleum diesel.",
      icon: Leaf,
    },
    {
      num: "02",
      title: "Direct Engine Drop-in",
      desc: "Can be blended seamlessly with petrodiesel or used directly, requiring zero to minimal modifications to existing diesel engines and fueling infrastructure.",
      icon: Fuel,
    },
    {
      num: "03",
      title: "Enhanced Engine Longevity",
      desc: "Naturally possesses higher lubricity than ultra-low sulfur diesel (ULSD), significantly reducing engine wear and extending the lifespan of fuel injection systems.",
      icon: ShieldCheck,
    },
    {
      num: "04",
      title: "Circular Waste Economy",
      desc: "Transforms costly environmental liabilities like used cooking oil (UCO) and animal fats into a valuable, high-performance liquid energy asset.",
      icon: Sprout,
    },
  ];
        ...
        <div className="w-full lg:w-1/3 lg:sticky lg:top-32 h-fit z-20">
          ...
          >
            ...
            <p className="text-[var(--color-text-muted)] text-lg leading-relaxed mb-10 font-light">
              A premium, drop-in replacement for petroleum diesel that turns waste oils and fats into clean, high-lubricity fuel for heavy-duty transportation and machinery.
            </p>
