...
import { ArrowRight, Leaf, Factory, Plane, Droplets, Zap } from "lucide-react";
import { motion } from "framer-motion";

export default function Pillars() {
  // Data completely preserved in structure, updated for SAF EPC
  const pillars = [
    {
      title: "Feedstock Management",
      category: "UCO · TALLOW · VEGETABLE OILS",
      badgeTitle: "Multi-Feed",
      badgeSub: "Feedstock Handling",
      desc: "Robust systems for the collection, sorting, and pre-treatment of lipids and waste oils to ensure a consistent, high-quality supply for SAF conversion.",
    ...
    },
    {
      ...
      category: "HEFA · ATJ · GASIFICATION",
      badgeTitle: "ASTM D7566",
      badgeSub: "Certified Pathway",
      desc: "Leading-edge conversion units (Hydroprocessed Esters and Fatty Acids) that transform renewable oils into drop-in aviation fuel molecules.",
      img: "https://media.istockphoto.com/id/2155090853/photo/datalake-big-data-warehouse-data-lake-platform-analytics-technology.webp?a=1&b=1&s=612x612&w=0&k=20&c=XAvhRMah5Eco86jYm5cByMFUYI44lgUw8XFPlDGQJ8Y=",
      span: "lg:col-span-1",
      height: "h-[400px] lg:h-[500px]",
      icon: Factory,
    },
    {
      ...
      category: "DISTILLATION · ISOMERIZATION",
      badgeTitle: "Premium",
      badgeSub: "Jet-Fuel Quality",
      desc: "High-precision refining and fractionation processes to ensure SAF meets rigorous density, freezing point, and energy content requirements for flight.",
      img: "https://images.unsplash.com/photo-1591273378246-397331fcdc43?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8UmVmaW5pbmclMjAlMjYlMjBGcmFjdGlvbmF0aW9ufGVufDB8fDB8fHww",
      span: "lg:col-span-1",
      height: "h-[360px]",
      icon: Plane,
    },
    {
      ...
      category: "JET A-1 · INFRASTRUCTURE READY",
      badgeTitle: "Drop-in",
      badgeSub: "Fuel Ready",
      desc: "Advanced blending infrastructure to seamlessly integrate SAF with conventional Jet A-1 fuel, allowing immediate use in existing aircraft engines.",
      img: "https://images.unsplash.com/photo-1658387575528-88b316c42371?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Q2VydGlmaWVkJTIwQmxlbmRpbmd8ZW58MHx8MHx8fDA%3D",
      span: "lg:col-span-1",
      height: "h-[360px]",
      icon: Droplets,
    },
    {
      title: "Logistics & Hydrants",
      category: "STORAGE · AIRSIDE · PIPELINES",
      badgeTitle: "Scalable",
      badgeSub: "Supply Chain",
      desc: "Comprehensive solutions for the safe storage, handling, and distribution of SAF through existing airport hydrant systems and logistics networks.",
      img: "https://plus.unsplash.com/premium_photo-1682126672871-6ca0eedbb390?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8TG9naXN0aWNzJTIwJTI2JTIwSHlkcmFudHN8ZW58MHx8MHx8fDA%3D",
      span: "lg:col-span-1",
      height: "h-[360px]",
      icon: Zap,
    },
      ...
      >
        <div>
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-[3.5rem] text-[var(--color-text)] leading-[1.1]">
            ...
            <span className="italic text-[var(--color-secondary)]">Sustainable Aviation Fuel</span> EPC
          </h2>
        </div>

        <div className="flex items-end">
          <p className="text-[var(--color-muted)] max-w-lg text-lg">
            Delivering complete infrastructure for next-generation aviation fuels — from feedstock handling and chemical conversion to certified blending and airside distribution.
          </p>
        </div>
      </motion.div>
