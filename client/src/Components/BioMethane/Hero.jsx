  ...
  return (
    <header className="relative pt-40 pb-24 px-8 min-h-screen flex flex-col justify-center border-b border-[var(--color-border)] overflow-hidden bg-[var(--color-bg-deep)]">
      ...
      <motion.div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1767789083299-28d17c4ffb7a?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 mt-16">
        ...
        <div className="flex flex-col justify-end pb-4">
          ...
          >
            Turn organic waste into high-purity biomethane with advanced EPC solutions — from feedstock handling to gas upgrading and compression systems.
          </motion.p>
