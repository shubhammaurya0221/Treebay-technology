...
export default function Stats() {
  const stats = [
    { end: 25, suffix: "Plants", label: "Successfully Commissioned" },
    { end: 5000, suffix: "Nm³/day", label: "Max Bio-CNG Capacity Delivered" },
    { end: 90, suffix: "%", label: "Methane Purity Achieved" },
    { end: 99, suffix: "%", label: "On-Time Project Delivery" },
  ];
