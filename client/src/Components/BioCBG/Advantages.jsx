...
import { Leaf, Network, Flame, Sprout, ArrowUpRight } from "lucide-react";
  ...
  const advantages = [
    {
      ...
      desc: "By capturing methane that would otherwise escape into the atmosphere from decomposing waste, biomethane significantly reduces greenhouse gas emissions.",
      icon: Leaf,
    },
    {
      num: "02",
      title: "Direct Grid Drop-in",
      desc: "Purified biomethane is chemically identical to natural gas, allowing immediate injection into existing gas pipelines without any infrastructure changes.",
      icon: Network,
    },
    {
      num: "03",
      title: "Versatile Energy Source",
      desc: "Functions as a highly flexible fuel suitable for base-load electricity generation, industrial heating, and as Bio-CNG for heavy-duty transportation.",
      icon: Flame,
    },
    {
      num: "04",
      title: "Circular Waste Economy",
      desc: "Transforms costly municipal and agricultural waste liabilities into a valuable energy asset, while yielding nutrient-rich digestate for farming.",
      icon: Sprout,
    },
  ];
        ...
        <div className="w-full lg:w-1/3 lg:sticky lg:top-32 h-fit z-20">
          ...
          >
            ...
            <p className="text-[var(--color-text-muted)] text-lg leading-relaxed mb-10 font-light">
              A premium, drop-in replacement for fossil natural gas that turns organic waste liabilities into clean, dispatchable energy and valuable agricultural nutrients.
            </p>
