...
export const Testimonial = () => {
  ...
  return (
    ...
    <section className="py-24 px-8 max-w-[90rem] w-full mx-auto border-b border-white/5">
      <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="flex gap-4 h-[400px] md:h-[500px] lg:h-[600px]">
          ...
          {/* Main large image */}
          <div className="w-2/3 h-full bg-[#050905] border border-white/10 relative overflow-hidden rounded-sm">
          ...
          <div className="w-1/3 flex flex-col gap-4">
            {testimonials.map((test, idx) => (
              <button 
                ...
                className={`w-full aspect-square bg-[#050905] border relative overflow-hidden rounded-sm transition-all focus:outline-none ${
                  currentIndex === idx 
                    ? 'border-[#c29a4b] ring-1 ring-[#c29a4b]' 
        ...
        <div className="flex flex-col justify-center">
          <h2 className="text-[#c29a4b] text-[10px] font-bold tracking-[0.2em] uppercase mb-6">
            Client Experiences
          </h2>
          ...
          <div className="min-h-[160px] md:min-h-[180px] relative">
            {testimonials.map((test, idx) => (
              <blockquote 
                key={`quote-${test.id}`}
                className={`text-2xl md:text-3xl lg:text-4xl font-serif font-light italic text-gray-300 leading-relaxed transition-all duration-700 ease-out ${
                  currentIndex === idx 
          ...
          <div className="flex gap-4 z-10">
            <button 
              onClick={handlePrev}
              className="w-12 h-12 border border-white/20 rounded-full flex items-center justify-center text-white hover:bg-white/10 hover:border-white/40 transition-all focus:outline-none"
            ...
            <button 
              onClick={handleNext}
              className="w-12 h-12 bg-[#1c6b36] text-white rounded-full flex items-center justify-center hover:bg-[#144f27] transition-all focus:outline-none shadow-lg shadow-black/20"
