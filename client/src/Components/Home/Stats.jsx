...
export const Stats = () => {
  ...
  return (
    <div className="border-b bg-[#0c1a10] border-white/10">
      <div className="max-w-[90rem] mx-auto grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10">
        {stats.map((stat, idx) => (
          <div key={idx} className="py-12 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs text-[#c29a4b] tracking-widest uppercase mt-2">
              {stat.label}
            </p>
          </div>
        ))}
