  ...
  return (
    <header className="relative pt-40 pb-24 px-8 min-h-screen flex flex-col justify-center border-b border-[var(--color-border)] overflow-hidden bg-[var(--color-bg-deep)]">
      ...
      <motion.div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1472313420546-a46e561861d8?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 mt-16">
        ...
        <div>
          ...
          >
            ...
            <h2 className="text-[var(--color-secondary)] text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase">
              Zero Carbon. Infinite Potential.
            </h2>
          </motion.div>
        ...
        <div className="flex flex-col justify-end pb-4">
          ...
          >
            Transform water and renewable energy into zero-carbon hydrogen fuel with advanced EPC solutions — from electrolysis systems to storage and distribution infrastructure.
          </motion.p>
