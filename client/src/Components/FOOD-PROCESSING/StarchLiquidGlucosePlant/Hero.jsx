...
import liqglucose from '../../../assets/images/liq-glucose/liq-glucose.png'
  ...
  return (
    <header className="relative pt-40 pb-24 px-8 min-h-screen flex flex-col justify-center border-b border-[var(--color-border)] overflow-hidden bg-[var(--color-bg-deep)]">
      ...
      <motion.div
        ...
        style={{
          backgroundImage: `url(${liqglucose})`
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 mt-16">
        ...
        <div>
          ...
          <motion.h1
            ...
            className="font-serif text-[2rem] sm:text-5xl md:text-5xl lg:text-6xl xl:text-[5rem] leading-[1] text-[var(--color-text)] max-w-4xl"
          >
            Leading <br />
        ...
        <div className="flex flex-col justify-end pb-4">
          ...
          >
            Treebay Technology designs and commissions high-efficiency plants. We empower your business with automated, high-yield processing technologies—from raw material handling to final refinement.
          </motion.p>
          ...
          >
            ...
            >
              Get a Consultation <ArrowRight size={14} />
            </motion.button>
