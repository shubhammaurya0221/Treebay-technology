...
export default function Stats() {
  const stats = [
    { end: 10, suffix: "+", label: "Years of Engineering Excellence" },
    { end: 10, suffix: "+", label: "Turnkey Projects Delivered Globally" },
    { end: 100, suffix: "+", label: "Customized Processing Solutions" },
