  ...
  return (
    <header className="relative pt-40 pb-24 px-8 min-h-screen flex flex-col justify-center border-b border-[var(--color-border)] overflow-hidden bg-[var(--color-bg-deep)]">
      ...
      <motion.div
        ...
        style={{
          backgroundImage:
            "url('https://t4.ftcdn.net/jpg/09/25/71/17/360_F_925711796_jvfXwSM1oMSev9oy5sd2CmR3G2xNyHNg.jpg')",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 mt-16">
        ...
        <div>
          ...
          >
            ...
            <h2 className="text-[var(--color-secondary)] text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase">
              From Plastic Waste to Clean Energy
            </h2>
          </motion.div>
          ...
          >
           Powering Circular Economy with <br />
        ...
        <div className="flex flex-col justify-end pb-4">
          ...
          >
           Transform non-recyclable plastic waste into valuable fuels with advanced EPC solutions — from feedstock processing to thermal conversion, refining, and energy recovery systems.
          </motion.p>
