...
import { Zap, Gauge, Beaker, Truck, ArrowUpRight } from "lucide-react";
  ...
  const advantages = [
    {
      ...
      desc: "Bio-iso-butanol delivers significantly higher energy output compared to ethanol, enabling improved fuel efficiency and reduced consumption.",
      icon: Zap,
    },
    {
      num: "02",
      title: "Lower Volatility",
      desc: "Its lower vapor pressure enhances safety in storage and transportation, minimizing evaporation losses and handling risks.",
      icon: Gauge,
    },
    {
      num: "03",
      title: "Superior Blending",
      desc: "Blends seamlessly with gasoline at higher ratios without requiring major engine or infrastructure modifications.",
      icon: Beaker,
    },
    {
      num: "04",
      title: "Pipeline Ready",
      desc: "Unlike ethanol, bio-iso-butanol can be transported through existing fuel pipelines, reducing logistics costs and complexity.",
      icon: Truck,
    },
  ];
        ...
        <div className="w-full lg:w-1/3 lg:sticky lg:top-32 h-fit">
          ...
          >
            ...
            <p className="text-[var(--color-text-muted)] text-lg leading-relaxed mb-10">
              A next-generation biofuel engineered to outperform traditional ethanol — delivering higher efficiency, safer handling, and seamless integration with existing infrastructure.
            </p>
